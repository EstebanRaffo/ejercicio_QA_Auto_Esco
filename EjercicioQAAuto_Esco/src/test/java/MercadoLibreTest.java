...
public class MercadoLibreTest {
    ...
    public MercadoLibreTest(String categoria_elegida, String subcategoria_elegida, String categoria_con_submenu_elegida, String subcategoria_de_categoria_con_submenu_elegida){
